...
from calculate_uniform_utilizations import get_uniform_utilizations
...
# DEFAULT_CONFIGS = {'hotel-reserv-frontend': 5, 'hotel-reserv-geo': 5, 'hotel-reserv-profile': 5, 'hotel-reserv-rate': 5,
#                    'hotel-reserv-recommendation': 5, 'hotel-reserv-reservation': 5, 'hotel-reserv-search': 5,
#                    "user": 5}
...
def get_poisson_rate(requests):
    ...
    rps = [840.5083333, 708.1833333, 613.3666667, 544.9333333, 483.4333333, 432.8, 393.3, 364.0583333, 339.7416667,
           315.3416667]
    poisson = [25, 30, 35, 40, 45, 50, 55, 60, 65, 70]
    #
    x = np.array(rps)
    y = np.array(poisson)
    f = interp1d(x, y)
...
DEFAULT_CONFIGS = {'hotel-reserv-frontend': 2.4, 'hotel-reserv-geo': 0.6, 'hotel-reserv-profile': 1.0, 'hotel-reserv-rate': 0.5, 'hotel-reserv-recommendation': 0.4,
                   'hotel-reserv-reservation': 0.8, 'hotel-reserv-search': 0.8, 'hotel-reserv-user': 0.4}
...
if __name__ == '__main__':
    ...
    while data_size:
        ...
        #     DEFAULT_CONFIGS[key] -= round(DEFAULT_CONFIGS[key] * 0.05, 2)
