...
DEFAULT_CONFIGS = {'compose-review-service': 1.2, 'movie-id-service': 0.5, 'movie-review-service': 0.5,
                   'nginx-web-server': 0.8, 'rating-service': 0.5, 'text-service': 0.3, 'user-service': 0.3}
